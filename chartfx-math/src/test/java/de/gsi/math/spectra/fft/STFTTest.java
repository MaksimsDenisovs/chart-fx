...
import de.gsi.math.spectra.fft.ShortTermFastFourierTransform.Padding;
 ...
 * TODO: Add tests that transform various test functions and verify the expected spectra.
 * 
...
class STFTTest {
    ...
    public void testRealSTFT() {
        ...
        DataSet3D sineSpectrogram = ShortTermFastFourierTransform.getSpectrogram(sine, N_FREQ, N_T);
    ...
    public void testComplexSTFT() {
        ...
        DataSet3D sineSpectrogram = ShortTermFastFourierTransform.getComplexSpectrogram(sine, N_FREQ, N_T,
